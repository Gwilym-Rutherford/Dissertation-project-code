...
for patient_index in range(n_patients):
    ...
    # this only trains without fatigue appended
    # w, x, y, z = train_data.shape
    # train_data = train_data.reshape(w, x, y * z)

    # test_data = test_data.unsqueeze(dim=0)
    # w, x, y, z = test_data.shape
    # test_data = test_data.reshape(w, x, y * z)
