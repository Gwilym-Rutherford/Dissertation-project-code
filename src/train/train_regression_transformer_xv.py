...
class TransformerRegressionXV:
    def __init__(self, dmo_data, dmo_labels, config, transformer_config, device, k=5, seed=1234):
    ...
    def train_cross_validation(self):
        ...
        for split_i in range(self.k_folds):
            ...
            model = DMOTransformer(**self.transformer_config).to(device=self.device)
